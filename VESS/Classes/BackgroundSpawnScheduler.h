...
public:
	enum OBJECT {MOUNTAIN, POLE, TILE};
...
public:
	...
	BackgroundSpawnSchedulerTimer(EnumBackground::OBJECT object, FightLayer* layer, float scale, EnumBackground::ArrangePosition arrangePosition);// 어떤오브젝트 생성할지, 생성한 걸 어떤레이어에 addchild 할지, 오브젝트 생성 간격
};
